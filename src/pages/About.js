...
import '../App.css';
import pic from './image/filename.png';
                ...
                <hr/>
                    <section className="row">
                        ...
                        <article className="col-lg-10">
                            <img src={pic} hspace='5' className="img-fluid float-md-left rounded" alt="Hanan Yusuf" />
                            ...
                            <p>As a beginner developer, I have aquired a working knowledge of HTML, CSS, JavaScript, Jquery, MySQL, Mongoose, NodeJS and ReactJs in my three months of the boot camp.</p>
